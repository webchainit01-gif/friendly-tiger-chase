...
const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
  return (
    <RevealOnScroll animation="fade-in-up">
      <Card className="bg-white rounded-xl shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-[1.02] hover:shadow-xl border border-gray-100 group">
