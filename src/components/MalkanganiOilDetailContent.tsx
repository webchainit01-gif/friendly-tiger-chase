    ...
    <div className="container mx-auto py-16 px-4 bg-white rounded-lg shadow-sm my-8">
      <div className="flex flex-col md:flex-row gap-12 items-center">
        ...
        <div className="md:w-1/2 text-center md:text-left">
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-2 text-base mb-6">
          ...
          <p className="text-gray-700 text-base mb-8 leading-relaxed">
            A <span className="font-bold">natural companion for every age group</span> – Malkagni Oil strengthens both <span className="font-bold">mind and body.</span>
          </p>
      ...
      <div className="prose max-w-4xl mx-auto text-gray-700 leading-relaxed mt-12">
        ...
        <p className="font-bold mb-3">Effective in:</p>
        <ul className="list-disc list-inside space-y-2 mb-6">
