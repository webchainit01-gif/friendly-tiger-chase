...
const HerbCard: React.FC<HerbCardProps> = ({ herb }) => {
  return (
    <RevealOnScroll animation="fade-in-up">
      <Card
        className="bg-white rounded-xl shadow-md overflow-hidden transform transition-transform duration-300 hover:scale-[1.02] hover:shadow-lg border border-gray-100 flex flex-col justify-between"
      >
          ...
          <div className="text-center mt-8">
            <Button
              ...
              className="border-green-600 text-green-600 hover:bg-green-50 hover:text-green-700 rounded-full px-6 py-2
                         transition-all duration-300 hover:shadow-md hover:shadow-green-200"
            >
