...
const HeroSection = () => {
  return (
    <section className="relative min-h-[750px] md:min-h-[700px] lg:min-h-[800px] flex items-center justify-center overflow-hidden bg-gradient-to-br from-yellow-500 to-yellow-700 px-4 py-16">
